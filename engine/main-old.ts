/* This is the prototyped demo for the EDGY Engine
 * This code also functions as the demonstration of technology feasibility
 * This file is copied to the engine directory for reference only and is excluded from the build
 * Remember to discard this file when the engine is complete
 */
